...
class AppsController extends Controller{
    ...
    async taskDetailAction(){
        ...
        const task = http.getContextData('task');
        const app = http.getContextData('app');
        ...
        try{
            ...
            user = null;
            this.log.error(`[dash.apps.taskDetailAction]根据任务的userId获取对应用户异常！ taskId[${task.id}] userId[${task.userId}]  错误信息： ${err.message}`);
        }
